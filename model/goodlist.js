...
module.exports = {
	...
	goodAll: function (req, res, next) {
        pool.getConnection(function(err, connection) {
            ...
            if (categoryId) {
                connection.query($sql.getGoodsByCategoryId, categoryId, function(err, result) {
                    jsonWrite(res, {
                        code: 0,
                        msg: '',
                        data: result
    ...
    bannerAll: function (req, res, next) {
        pool.getConnection(function(err, connection) {
            connection.query($sql.getAllBanner, function(err, result) {
                jsonWrite(res, {
                    code: 0,
                    msg: '',
                    data: result
